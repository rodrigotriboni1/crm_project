-- Modulo Equipe MVP: data_scope, assigned_user_id, RLS, teams, audit, RPCs
...
-- NOT NULL below: ON DELETE SET NULL would conflict with auth.users deletes
...
-- Postgres cannot change RETURNS TABLE row type with CREATE OR REPLACE alone
drop function if exists public.list_clientes_com_ultimo_contato(uuid, boolean);
