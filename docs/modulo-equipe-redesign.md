...
Hoje o “módulo de equipe” é essencialmente **multi-tenant por organização** com papéis **owner | member**, convites por e-mail/link e listagem de membros. Não há **times** dentro da org, **papéis operacionais** (gestor/vendedor), **escopo de visibilidade** fino, **atribuição automática** nem **auditoria** de mudanças organizacionais. Este documento define visão alvo, modelagem sugerida, backlog e checklist de execução.
