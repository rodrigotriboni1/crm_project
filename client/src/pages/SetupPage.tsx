export default function SetupPage() {
  return (
    <div className="flex min-h-screen flex-col bg-brand-light lg:flex-row">
      <div className="flex flex-1 flex-col justify-center border-b border-border bg-[#141413] px-8 py-12 text-[#faf9f5] lg:border-b-0 lg:border-r lg:py-16 lg:pl-14 lg:pr-10">
        ...
        <p className="mt-4 max-w-md font-serif text-sm leading-relaxed text-[#b0aea5]">
      ...
      <div className="flex flex-1 flex-col justify-center px-8 py-12 md:px-12">
        <div className="mx-auto max-w-md space-y-6">
          <ol className="list-decimal space-y-4 pl-5 font-serif text-sm leading-relaxed text-muted-foreground">
            <li>
              Crie um projeto em{' '}
              <a
          ...
          <p className="border-t border-border pt-6 font-serif text-xs text-brand-mid">
